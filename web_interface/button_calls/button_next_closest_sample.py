...
def click_next_closest_sample(distance_type_dataset, current_sample_id, closest_list_state, closest_index_state, smooth_method_dropdown, smooth_factor, smooth_window_slider, n_samples):
    """
